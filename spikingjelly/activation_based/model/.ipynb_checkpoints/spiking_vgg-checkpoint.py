...
from .. import functional, neuron, layer, attention
    ...
    def make_layers(cfg, batch_norm=False, norm_layer=None, neuron: callable = None, att=None, **kwargs):
        ...
        for v in cfg:
            if v == 'M':
                ...
                if batch_norm:
                    layers += [conv2d, attention.CSA(channels=v), norm_layer(v),  neuron(**deepcopy(kwargs))]
                else:
...
cfgs = {
    ...
    'B': [64, 64, 128, 128, 256, 256, 'M', 512, 512, 512, 512],
    'D': [64, 64, 128, 128, 256, 256, 256, 'M', 512, 512, 512, 512, 512, 512],
